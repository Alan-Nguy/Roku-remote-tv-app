    ...
    return (
      ...
      >
        {iconUri ? (
          ...
          <View style={[styles.appIconPlaceholder, { backgroundColor: colors.buttonBg }]}>
        ...
        {isLaunching ? (
          ...
          <MaterialIcons name="play-circle-filled" size={22} color={colors.tint} />
        ) : (
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {!connectedDevice ? (
        ...
        <FlatList
          ...
          refreshControl={
            <RefreshControl refreshing={loading} onRefresh={fetchApps} tintColor={colors.tint} />
          }
          ListEmptyComponent={
            loading ? (
