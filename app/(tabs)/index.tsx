...
import { sendKeypress, RokuKey } from '@/services/roku';
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.row}>
          <RemoteButton icon="power-settings-new" onPress={() => press('Power')} variant="danger" size="medium" />
          <RemoteButton icon="home" onPress={() => press('Home')} size="medium" />
          <RemoteButton icon="arrow-back" onPress={() => press('Back')} size="medium" />
        </View>

        {/* D-Pad */}
        <View style={[styles.dpadContainer, { backgroundColor: colors.card, borderColor: colors.cardBorder }]}>
          {/* Up */}
          <View style={styles.dpadRow}>
            <RemoteButton icon="keyboard-arrow-up" onPress={() => press('Up')} variant="round" size="large" />
          </View>
          {/* Left, Select, Right */}
          <View style={styles.dpadRow}>
            <RemoteButton icon="keyboard-arrow-left" onPress={() => press('Left')} variant="round" size="large" />
            <RemoteButton
              label="OK"
            ...
            />
            <RemoteButton icon="keyboard-arrow-right" onPress={() => press('Right')} variant="round" size="large" />
          </View>
          {/* Down */}
          <View style={styles.dpadRow}>
            <RemoteButton icon="keyboard-arrow-down" onPress={() => press('Down')} variant="round" size="large" />
          </View>
        </View>

        {/* Media Controls */}
        <View style={styles.row}>
          <RemoteButton icon="fast-rewind" onPress={() => press('Rev')} size="medium" />
          <RemoteButton icon="play-arrow" onPress={() => press('Play')} variant="accent" size="medium" />
          <RemoteButton icon="fast-forward" onPress={() => press('Fwd')} size="medium" />
        </View>

        {/* Volume Controls */}
        <View style={styles.row}>
          <RemoteButton icon="volume-down" onPress={() => press('VolumeDown')} size="medium" />
          <RemoteButton icon="volume-off" onPress={() => press('VolumeMute')} size="medium" />
          <RemoteButton icon="volume-up" onPress={() => press('VolumeUp')} size="medium" />
        </View>
        ...
        {lastError && (
          <Text style={[styles.error, { color: colors.dangerText }]}>{lastError}</Text>
        )}
      </ScrollView>
    </SafeAreaView>
  );
