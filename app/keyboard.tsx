...
import { sendText, sendKeypress } from '@/services/roku';
        ...
        <View style={styles.content}>
          ...
          <View style={styles.actions}>
            ...
            >
              ...
              <Text style={[styles.actionText, { color: colors.text }]}>Backspace</Text>
            </Pressable>
            ...
            <Pressable
              ...
              style={[
                styles.actionButton,
                { backgroundColor: colors.tint, opacity: !text.trim() ? 0.4 : 1 },
              ]}
            >
              {sending ? (
                ...
                <>
                  ...
                  <Text style={[styles.actionText, { color: '#fff' }]}>Send Text</Text>
                </>
              )}
            </Pressable>
          </View>
          ...
          >
            <MaterialIcons name="keyboard-return" size={20} color={colors.tint} />
          ...
          {sent && (
            <View style={styles.sentConfirm}>
              ...
              <Text style={[styles.sentText, { color: colors.success }]}>Text sent!</Text>
            </View>
          )}
        </View>
      )}
