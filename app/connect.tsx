...
export default function ConnectScreen() {
	...
	const { connectedDevice, savedDevices, connect, loadSaved } =
		useDeviceStore();
		...
		>
			...
			{statusMessage && (
				...
				>
					...
					<Text
						style={[styles.statusText, { color: colors.subtle }]}
						numberOfLines={3}
					>
						{statusMessage}
					</Text>
			...
			>
				<Text style={[styles.sectionTitle, { color: colors.text }]}>
					...
					{detectedIp && (
						<Text
							style={{ color: colors.success, fontWeight: "400", fontSize: 12 }}
						>
							{"  "}(auto-detected)
						</Text>
					)}
				...
				<View style={styles.scanRow}>
					...
					/>
					<Text style={[styles.subnetSuffix, { color: colors.subtle }]}>
						.1-254
					</Text>
					<Pressable
						onPress={handleScan}
